...
目前是研究原型。32 局已结束，19 局通过第一幕。最远记录仍为第二幕 Boss，尚未通关。第 32 局通过第一幕后，在第二幕第 27 层精英战失败；[复盘](docs/run32-review.md)发现并修正了节段复活的条件表达。实时记录见[整局进展](docs/full-run-progress.md)。
